...
static int gpio_lmp90xxx_manage_callback(struct device *dev,
...
static int gpio_lmp90xxx_enable_callback(struct device *dev,
					 int access_op,
					 u32_t pin)
{
	/* LMP90xxx GPIOs do not support interrupts */
...
static int gpio_lmp90xxx_disable_callback(struct device *dev,
					  int access_op,
					  u32_t pin)
{
	/* LMP90xxx GPIOs do not support interrupts */
...
static u32_t gpio_lmp90xxx_get_pending_int(struct device *dev)
{
	/* LMP90xxx GPIOs do not support interrupts */
	return 0;
}
...
static const struct gpio_driver_api gpio_lmp90xxx_api = {
	...
	.manage_callback = gpio_lmp90xxx_manage_callback,
	.enable_callback = gpio_lmp90xxx_enable_callback,
	.disable_callback = gpio_lmp90xxx_disable_callback,
	.get_pending_int = gpio_lmp90xxx_get_pending_int,
};
